...
import { parseOfferPrice, parseFlights, parseDiscountPrice, parsePromo, parseChildrenAges, parsePeople, parseSubOperator, extractBookingData, scheduleOfBookingPaymentsMapper, extractExternalOperatorData } from '../parsers';
const applyTimeZoneToOfferUpdateTime = updateTime => applyTimeZoneToDate(updateTime, 'YYYY-MM-DD HH:mm:ss');
export const offerSchema = new schema.Entity('offer', {}, {
  ...
  processStrategy: input => {
    ...
    const entity = {
      ...
      scheduleOfBookingPayments: scheduleOfBookingPayments ? scheduleOfBookingPaymentsMapper(scheduleOfBookingPayments) : null,
