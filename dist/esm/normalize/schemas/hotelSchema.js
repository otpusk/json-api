...
export const hotelSimilarSchema = new schema.Entity('hotel', {}, {
  idAttribute: _ref2 => {
    let {
      id
    } = _ref2;
...
export const hotelSchema = new schema.Entity('hotel', {
  offers: [offerSchema]
}, {
  idAttribute: _ref3 => {
    let {
  ...
  processStrategy: input => {
    ...
    const optional = {
      secondaryStars: parseSecondaryStars(typeof stars === 'object' ? stars.n : stars, typeof secondaryStars === 'object' ? secondaryStars.n : secondaryStars)
    };
...
export const hotelNextSchema = new schema.Entity('hotel', {}, {
  idAttribute: _ref6 => {
    let {
      i
    } = _ref6;
