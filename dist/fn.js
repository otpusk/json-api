 ...
 */
function _makeCall() {
  _makeCall = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          cache = new _cache2.CacheItem(hash(request));
          _context2.next = 5;
...
var HttpResponseError = exports.HttpResponseError = /*#__PURE__*/_createClass(function HttpResponseError(code, message) {
