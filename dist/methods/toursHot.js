...
function _getToursHotTour() {
  _getToursHotTour = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(token, blockId, tourId) {
    var _yield$makeCall2, _yield$makeCall2$sear, _yield$makeCall2$sear2, offers;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _yield$makeCall2$sear2 = _yield$makeCall2$sear === void 0 ? {} : _yield$makeCall2$sear;
          offers = _yield$makeCall2$sear2.offers;
          if (offers) {
            _context2.next = 8;
            break;
          }
