...
function _getToursHotels() {
  _getToursHotels = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, countryId) {
    var options,
      methodVersion,
      _options$services,
      services,
...
function _getToursHotelsMarkers() {
  _getToursHotelsMarkers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(token, countryId, cityId, options) {
...
function _getToursHotel() {
  _getToursHotel = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(token, hotelId) {
    var lang,
      _yield$makeCall3,
      denormalizedHotel,
      _normalize3,
