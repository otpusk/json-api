...
var _excluded = ["icons", "tabs", "nameServices", "chains", "search"];
...
var chainsToArray = function chainsToArray(chains) {
  return R.call(R.pipe(R.toPairs, R.map(function (_ref6) {
...
var extractServicesFromResponse = function extractServicesFromResponse(response) {
  return R.call(R.pipe(R.toPairs, R.filter(function (_ref9) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          _yield$makeCall$chain = _yield$makeCall.chains;
          chains = _yield$makeCall$chain === void 0 ? {} : _yield$makeCall$chain;
          search = _yield$makeCall.search;
          response = _objectWithoutProperties(_yield$makeCall, _excluded);
