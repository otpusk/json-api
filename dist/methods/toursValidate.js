...
var _excluded = ["status"],
  _excluded2 = ["info", "usd", "uah", "eur", "currency"];
...
function _getToursValidate() {
  _getToursValidate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, offerId) {
