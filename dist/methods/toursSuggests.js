...
// Instruments
var getIndexFromResult = function getIndexFromResult(id, result) {
  return result.findIndex(function (_ref) {
    var own = _ref.id;
    return id === own;
  });
};
...
function _getToursSuggests() {
  _getToursSuggests = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, query) {
    var options,
      _yield$makeCall,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          resultLocations = Object.fromEntries(Object.entries(locations).map(function (_ref2) {
            var _ref3 = _slicedToArray(_ref2, 2),
              key = _ref3[0],
              group = _ref3[1];
            return [key, Object.values(group).sort(function (_ref4, _ref5) {
              var a = _ref4.id;
              var b = _ref5.id;
...
function _getToursGeoById() {
  _getToursGeoById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(token, id) {
    var options,
      _yield$makeCall2,
      denormalizedLocations,
      _normalize2,
