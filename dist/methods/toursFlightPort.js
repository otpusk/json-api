...
var _excluded = ["id", "countryId", "countryIata", "countryName", "lat", "lng", "rel"];
...
function _getToursFlightPort() {
  _getToursFlightPort = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, iata) {
    var options,
      _yield$makeCall,
      port,
      id,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          id = port.id, countryId = port.countryId, countryIata = port.countryIata, countryName = port.countryName, lat = port.lat, lng = port.lng, rel = port.rel, rest = _objectWithoutProperties(port, _excluded);
