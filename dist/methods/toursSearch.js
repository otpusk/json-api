...
function _getToursSearch() {
  _getToursSearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, query) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          other = _objectWithoutProperties(_yield$makeCall, _excluded);
