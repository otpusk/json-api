...
var _excluded = ["currency", "currency_original", "price", "price_original", "perBooking", "number", "obligatory"];
...
var normalizeBookServices = function normalizeBookServices(services) {
  return (0, _ramda.map)(function (_ref) {
    var currency = _ref.currency,
      ...
      perBooking = _ref.perBooking,
      number = _ref.number,
      required = _ref.obligatory,
      service = _objectWithoutProperties(_ref, _excluded);
...
var prepareBookingServices = exports.prepareBookingServices = function prepareBookingServices(services) {
...
function _getToursBookServices() {
  _getToursBookServices = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tokenAsQuery, query) {
