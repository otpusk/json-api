...
var getChildAge = function getChildAge(birthdayDate) {
  return (0, _moment.default)().diff((0, _moment.default)(birthdayDate, 'YYYY-MM-DD'), 'years');
};
var buildChildrenQuery = function buildChildrenQuery(children) {
  return (0, _ramda.sortBy)(getChildAge, children).reduce(function (acc, child, index) {
    return _objectSpread(_objectSpread({}, acc), {}, _defineProperty({}, "child".concat(index + 1), child));
  }, {});
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          childrenBirthdays = _args.length > 5 && _args[5] !== undefined ? _args[5] : [];
          _context.next = 5;
          return (0, _fn.makeCall)({
            endpoint: _config.ENDPOINTS.actual,
            timeout: 40000,
            query: _objectSpread(_objectSpread(_objectSpread({}, token), {}, {
              offerId: offerId,
              people: people,
