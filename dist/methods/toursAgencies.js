...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Core
>>>>>>> task-45137
// Instruments
...
function _getToursAgencies() {
  _getToursAgencies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, _ref) {
    var regionId, hotelId, offerId, _ref$noStats, noStats, adMarketId, params, _yield$makeCall, operators, denormalizedRegions, _normalize, _normalize$entities, agencies, offices, _normalize$result$, _normalize$result$2, viewAgenciesOrder, _normalize2, regions;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          })), _normalize$entities = _normalize.entities, agencies = _normalize$entities.agency, offices = _normalize$entities.office, _normalize$result$ = _normalize.result[1], _normalize$result$2 = _normalize$result$ === void 0 ? {} : _normalize$result$, viewAgenciesOrder = _normalize$result$2.viewAgencies;
